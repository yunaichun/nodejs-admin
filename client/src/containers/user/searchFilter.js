...
import '../../style/upload/upload.less';
...
export class SearchFilter extends React.Component {
	...
	render() {
		...
		const { handleSubmit, handleChange, handleReset, handleCreate, handleImport, handleExport } = this.props;
		return (
			<Row gutter={24}>
				...
				<Col xl={{ span: 24 }} md={{ span: 24 }} sm={{ span: 24 }}>
					...
					>
						<div>
							<Button type="primary" size="large" style={{ marginRight: 16 }} onClick={handleSubmit}>
								Search
							</Button>
							<Button size="large" onClick={handleReset} style={{ marginRight: 16 }}>Reset</Button>
							<Button className="a-upload" style={{ marginRight: 16 }}>
								<input type="file" onChange={e => handleImport(e)} />导入Excel
							</Button>
							<Button className="a-upload" onClick={handleExport}>
							导出Excel
							</Button>
						</div>
						<div>
